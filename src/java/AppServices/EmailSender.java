...
public class EmailSender {
    ...
    public boolean sendPassword(String recipientEmail, String firstName, String lastName, String password) {

        var userName = getFormattedUserName(firstName, lastName);
    ...
    public boolean sendBill(String recipientEmail, String firstName, String lastName, String address, String phoneNumber, int billNumber, int appointmentNumber, String paymentDate, String testName, String charges) {
        ...
        var mailSubject = "ABC Restaurants - Payment Confirmation ";
        try {
            return sendMail(recipientEmail, mailSubject, htmlMailBody);
        } catch (KeyManagementException | NoSuchAlgorithmException e) {
            System.err.println(e);
    ...
    private String getFormattedUserName(String firstName, String lastName) {
        var customerName = "Mr./Ms." + firstName + " " + lastName;
        return customerName;
    }
